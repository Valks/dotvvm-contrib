...
/// <reference path="globalize/index.d.ts" />
...
declare class DotVVM {
    ...
    private handleHashChange(viewModelName, spaPlaceHolder);
...
declare class DotvvmFileUpload {
    ...
    reportProgress(targetControlId: string, isBusy: boolean, progress: number, result: DotvvmFileUploadData[] | string): void;
}
...
declare class DotvvmPromise<TArg> implements IDotvvmPromise<TArg> {
    ...
    fail(callback: (error) => void, forceAsync?: boolean): void;
    resolve(arg: TArg): void;
